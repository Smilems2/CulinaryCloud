...
const Caterersdash=() => {
  ...
  return (
    ...
    {/* <div class="container-xxl py-5 bg-dark hero-header mb-5 _length101">
 ...
 */}
        ...
        {/* <div class="container-xxl py-5">
            <div class="container _length102">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 class="section-title ff-secondary text-center text-primary fw-normal">Caterer's/Halwai</h5>
                    <h1 class="mb-5">Most Popular Caterer's</h1>
                </div>
            </div>
            <div className="belowcontainer _bec1o1">
                <hr></hr>
                <div className="Firstcaterers _fc001">
                    <div className="Leftsideoffc _lsoff1">
                        <img src={firstcater} className='imageoff' width="100%" height="270px" />
                    </div>
                    <div className="Rightsideoffc _rsoff1">
                        <div className="_rsoff10">
                            <div className="stardivr"><i class="fa-regular fa-star stars-5"></i></div>
                            <div className="taglinedivt">
                                <span>Home Catering Services Agra</span>
                            </div>
                        </div>
                        <div className="_rsoff20">
                            <div className="innerrsoff2">
                            <h3 className='titleofcater _toc1'>Caterers Touch</h3>
                            </div>
                        </div>
                        <div className="_rsoff30">
                            <div className="innerrsoff3">
                                <p className='rsofftext'>Caterers Touch is a catering service company loacted in Agra. There are a heap of things that takes place in a grand wedding function but one thing which elevates the look of the ceremony is scrump...<h6>Learn more</h6></p>
                            </div>
                        </div>
                        <div className="_rsoff40">
                            <div className="pricebox _prb101">
                                <div className="upperprb">Price from</div>
                                <div className="lowerprb">₹800</div>
                            </div>
                        </div>
                    </div>
                </div>
                <hr></hr>
                <div className="Secondcaterers _fc001">
                <div className="Leftsideoffc _lsoff1">
                        <img src={secondcater} className='imageoff' width="100%" height="270px" />
                    </div>
                    <div className="Rightsideoffc _rsoff1">
                        <div className="_rsoff10">
                            <div className="stardivr"><i class="fa-regular fa-star stars-5"></i></div>
                        ...
                        <div className="_rsoff20">
                            <div className="innerrsoff2">
                            <h3 className='titleofcater _toc1'>Mana Caterers</h3>
                            </div>
                        </div>
                        <div className="_rsoff30">
                            <div className="innerrsoff3">
                        ...
                        <div className="_rsoff40">
                            <div className="pricebox _prb101">
                                <div className="upperprb">Price from</div>
                                <div className="lowerprb">₹900</div>
                            </div>
                        </div>
                    </div>
                </div>
                <hr></hr>
                <div className="Thirdcaterers _fc001">
                <div className="Leftsideoffc _lsoff1">
                        <img src={thirdcater} className='imageoff' width="100%" height="270px" />
                    </div>
                    <div className="Rightsideoffc _rsoff1">
                        <div className="_rsoff10">
                            <div className="stardivr"><i class="fa-regular fa-star stars-5"></i></div>
                        ...
                        <div className="_rsoff20">
                            <div className="innerrsoff2">
                            <h3 className='titleofcater _toc1'>Tana Caterers</h3>
                            </div>
                        </div>
                        <div className="_rsoff30">
                            <div className="innerrsoff3">
                        ...
                        <div className="_rsoff40">
                            <div className="pricebox _prb101">
                                <div className="upperprb">Price from</div>
                                <div className="lowerprb">₹1000</div>
                            </div>
                        </div>
                    </div>
                </div>
                <hr></hr>
                <div className="Fourthcaterers _fc001">
                <div className="Leftsideoffc _lsoff1">
                        <img src={firstcater} className='imageoff' width="100%" height="270px" />
                    </div>
                    <div className="Rightsideoffc _rsoff1">
                ...
                <hr></hr>
                <div className="Fifthcaterers _fc001">
                <div className="Leftsideoffc _lsoff1">
                        <img src={firstcater} className='imageoff' width="100%" height="270px" />
                    </div>
                    <div className="Rightsideoffc _rsoff1">
