      ...
      {/* <!-- Service Start --> */}
        <div class="container-xxl py-5 _bgservice102" style={{backgroundColor: 'light'}}>
            ...
            <h3 class="section-title ff-secondary text-center text-primary fw-normal _shmarg104">Our Services</h3>
                ...
                <div class="row g-4 _shiftrow103">
                                ...
                                <ul>
                                    <li>
                                        <div class="p-4">
                                            ...
                                            {/* <h5>User SignUp</h5> */}
                                            <Link to="/Login" className='' activeClassName="active"><h5>User Signup</h5> </Link>
                        ...
                        <div class="service-item rounded pt-3">
                            <a href="#">
                                <div class="p-4">
                                    ...
                                    <Link to="/Vendorfirstpage" className='' activeClassName="active"><h5>Restaurant Partner</h5> </Link>
                        ...
                        <div class="service-item rounded pt-3">
                            <a href="#">
                                <div class="p-4">
                                    ...
                                    <Link to="/Deliveryboyregis" className='' activeClassName="active"><h5>Delivery Boy</h5> </Link>
                        ...
                        <div class="service-item rounded pt-3">
                            <a href='#'>
                                <div class="p-4">
                                    <i class="fa fa-3x fa-utensils text-primary mb-4"></i>
                                    {/* <h5>Confectioner</h5> */}
                                    <Link to="/Catererssignup" className='' activeClassName="active"><h5>Confectioner</h5> </Link>
