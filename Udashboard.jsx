    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        <div className="containerss">
            ...
            <div className="mainsss">
                    ...
                    <div className="itemss">
                        <div className="boxss">
                            ...
                            <div className="namess">
                                    <span className="title">OUR RASOI</span>
                                    <Link to="/UserSignUp" className="btn btn-primary py-2 px-4" activeClassName="active">UserSignUp</Link>

                                
                            </div>
                        </div>
                        <div className="space" style={{width: '50px'}}></div>
                        <div className="boxss">
                            <div className="imagess">

                            </div>
                            <div className="namess">
                                <span className="title">TIFFINS SERVICES</span>
                            </div>
                        </div>
                ...
                <div className="popularss">
                    <h3>Popular</h3>
                    <div className="main-boxss">
                        <div className="card1ss">
                            <div className="headingss">
                                <div className="off-tagss">15 % OFF</div>
                                <div className="likess"><i class="fa-solid fa-heart"></i></div>
                            </div>
                            <div className="image-boxss">
                                <img src={Dashimages} alt='Dashimages' width="183px" height="153px" className='dashimages _dsi001'/>
                            </div>
                            <div className="rating-boxss">
                                <div className="starss"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></div>
                                <div className="namess">
                                    <ul>
                                        <li>
                                            <Link to="/SBBMB" className='' activeclassname="active">
                                                <span className='_ti00tl'>Shri Misthan Bhandar</span>
                                            </Link>
                                        </li>
                                    </ul>
                                </div>
                            <div className="address-sectionss">
                                    <div className="addrss">Atz agra</div>
                                    <div className="add-buttonss">
                                        <ul>
                                            <li>
                                                <Link to="/Popup" className='' activeclassname="active">
                                                    <button id="plus-tab">ADD</button>
                                                </Link>
                                            </li>
                                        </ul>
                                        </div>
                        ...
                        <div className="card1ss second-card">
                            <div className="headingss">
                                <div className="off-tagss">15 % OFF</div>
                                <div className="likess"><i class="fa-solid fa-heart"></i></div>
                            </div>
                            ...
                            <div className="address-sectionss">
                                    <div className="addrss">Atz agra</div>
                                    <div className="add-buttonss"><button id="plus-tab">ADD</button></div>
                            </div>
                            </div>
                        </div>
                        <div className="card1ss third-card">
                            <div className="headingss">
                                <div className="off-tagss">15 % OFF</div>
                                <div className="likess"><i class="fa-solid fa-heart"></i></div>
                            </div>
                    ...
                    <div className="popularss second-popular">
                    {/* <h3>Popular</h3> */}
                    <div className="main-boxss">
                        <div className="card1ss">
                            <div className="headingss">
